...
export default function LatestCourse() {
  return (
    <div className={FooterBlock}>
      ...
      <img width={400} height={265} src="https://res.cloudinary.com/wesbos/image/fetch/w_400,q_auto,f_auto/https://courses.wesbos.com/images/BJS/BJS-Social-Share.png" alt="Beginner JavaScript" />
