...
![typeof values shown in the console](./typeof-operator-in-console.webp)
...
![simple math in the console](./arithmetic-calculations-in-console.webp)
...
![strings of 10 and 10 can be multiplied](./string-multiplication.webp)
...
![autocompletion of the Math static methods](./autocompletion-of-methods-in-console.webp)
...
![Console rouning 20.5 up to 21 and 20.2 down to 20](./math-round-in-console.webp)

There is also `Math.floor()` which will give you the lower end of that number.

![console showing 20.2 and 20.999999 rounded down to 20](./math-floor-in-console.webp)

We have `Math.ceil()` and that will give you the upper number.

![console showing 20.2 and 20.999999 rounded up to 21](./math-ceil-in-console.webp)
...
![Console showing Math.random() returning a random number each time](./math-random-in-console.webp)
...
![Each kid gets 6.66666666667 in the console](./each-kids-gets-6-dot-66666666667-in-console.webp)
...
![Each kid gets 6 smarties int he console](./each-kid-gets-6-in-console.webp)
...
![Modulo Operator returning 2](./modulo-operator-in-console.webp)
...
![A calculation returning infinity](./infinity-calculation-in-console.webp)

Negative infinity is also a number. Wes has never run into this in his programming, unless you have goofed something up.

![typeof Infinity returning a number](./typeof-infinity-returning-a-number-in-console.webp)
...
![NaN in console](./nan-in-console.webp)

**NaN** is a type of "number", which is confusing since it means not a number.

![typeof NaN is a number](./typeof-number-in-console.webp)
