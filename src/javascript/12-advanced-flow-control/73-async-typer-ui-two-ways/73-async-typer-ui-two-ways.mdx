...
![generate a random number with combination of Math.floor and Math.random in console](./1109.png)
...
![getRandomBetween function in console](./1110.png)
...
![produce subtring of a name using slice method](./1111.png)
...
![uncaught in promise - RangeError: maximum call stack exceeded](./1112.png)
