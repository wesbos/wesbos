...
Add a log of it works and refresh the forms page.
...
Let's say you have a link to an html page, like so 👇
...
Now if you were to refresh and try to submit, you would see this little error.
