...
Remember: When using `fetch`, you need to use a double promise to actually get the data. The first promise gets the response and the second one takes this response stream and parses the body as JSON into a JavaScript object.
