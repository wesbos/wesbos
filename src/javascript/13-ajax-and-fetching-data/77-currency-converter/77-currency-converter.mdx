...
![rendered html of a currency convertor](./1179.png)
...
![list of currencies and their currency code](./1180.png)
...
![browser console showing currency array output ](./1182.png)
...
![browser console showing nested currency array output](./1183.png)
...
![browser console output showing currencys](./1185.png)
...
![browser console showing outputs for currency form option tags](./1186.png)
...
![rendered page showing currency selection dropdown](./1187.png)
...
![api example for getting currency rates](./1188.png)
...
![browser console showing output from fetchRates endpoint using USD](./1189.png)

You can try passing the base currency as "CAD" and it should still work.

![browser console showing output from fetchRates endpoint using CAD](./1190.png)
...
![code snippet of ratesByBase const](./1191.png)
...
![browser console output showing no conversion available log](./1192.png)
...
![browser console showing empty ratesByBase object](./1193.png)
...
![browser console showing output from ratesByBase](./1194.png)
...
![browser output showing output from ratesByBase.CAD.rates](./1195.png)
...
![browser console showing successful conversion from CAD to USD](./1197.png)
...
![browser console output showing results from event](./1198.png)
...
![browser console showing raw amount values of the rates data](./1199.png)
...
![rendered page with the amount being highlighted by dev tools](./1200.png)
...
![rendered page showing returned values of the api](./1201.png)
...
![code snippet of formatCurrency](./1202.png)
...
![rendered page showing form](./1203.png)
...
![browser console showing the result from formatCurrency](./1204.png)
...
![rendered page showing form fully finished](./1205.png)
