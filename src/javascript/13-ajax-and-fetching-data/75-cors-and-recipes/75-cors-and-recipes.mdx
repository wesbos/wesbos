...
![response from recipepuppy api endpoint](./1131.png)
...
![a list of query params available on recipepuppy api endpoint](./1132.png)
...
![url showing parameters in a url](./1133.png)
...
![rendered html of a form](./1134.png)
...
![browser console showing CORS Policy error](./1135.png)
...
![browser network tab showing request has no response data](./1136.png)
...
![terminal window showing npm init](./1137.png)
...
![terminal window showing npm start](./1138.png)

Open that server in the browser and take a look at the error we are now getting in the console. 👇

![browser console showing Uncaught ReferenceError](./1139.png)
...
![browserlist github page](./1140.png)
...
![browser console showing CORS Policy error](./1141.png)
...
![os file system showing cache/ and dist/ folder locations](./1142.png)
...
![browser console showing CORS Policy error](./1143.png)
...
![google resulst for cors proxy](./1145.png)

Wes has found that the https://cors-anywhere.herokuapp.com one works the best.

![website cors-anywhere.herokuapp.com](./1146.png)
...
![browser console output showing response data](./1147.png)
...
![browser console output showing a value from the response data](./1149.png)
...
![rendered html showing disabled button](./1150.png)
...
![rendered page showing filled in form and browser console outputting the forms response data](./1151.png)
...
![browser console showing multiple recipe html outputs](./1152.png)
...
![rendered page of recipes](./1153.png)

![rendered html of recipes](./1154.png)
