...
![console showing logged value for defined variable and throws a reference error for undefined variable](/194.png)
...
Here is another example that is a bit more realistic, where we are getting into two different kinds of scopes 👇
