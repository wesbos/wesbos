...
![sarcastic text generator](./783.png)

![unable to structure a sentence generator](./782.png)

![funky text generator](./784.png)
...
![selecting textarea, paragraph and nodelist using querySelectorAll](./785.png)
...
![array of every single letter](./786.png)
...
![log the letter on typing text](./787.png)
...
![pack of 10 smarties (a candy in canada)](./788.png)
...
![divide and math.floor as wrong approach](./789.png)
...
![modulo operator in console](./791.png)
...
![upper/lowercase every other letter using modulo operator](./792.png)
...
![applying sarcastic filter to the text typed](./793.png)
...
![console log of characters typed](./794.png)

Now when we type in it, we get the selected filter type logged in the console.

![querySelector filter type checked to find the radio button checked](./795.png)
...
![error - filterInputs.find is not a function](./796.png)
...
![using Array.from method to covert the node list to array](./797.png)
...
![accessing the funky letter using its property assigned](./800.png)
...
![funkyLetters filter in action](./801.png)
...
![checking the lowercase version of funkyLetters](./803.png)
...
![generating a random number using math.random function](./804.png)
...
![unable to structure sentence output in action](./805.png)
