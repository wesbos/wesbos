...
![html structure for the gallery with bunch of images](./860.png)
...
![logging the gallery from within the Gallery function](./861.png)
...
![uncaught error: no gallery found](./862.png)
...
![selecting galleries using querySelector](./863.png)
...
![logging the images in console](./864.png)
...
![logging the gallery in console](./865.png)

As you can see, the gallery is showing up.

![gallery console log shows up](./866.png)

If we look inside of the gallery, we can see lots of image elements.

![image elements inside the gallery](./867.png)
...
![clicking on image element gets logged in console](./868.png)
...
![update the source of image, h2 and p element](./869.png)
...
![image tags along with several attributes](./871.png)
...
![modal values being swapped out when clicking on image](./872.png)
...
![modal css styles](./873.png)

However the modal with the class of `open` has opacity of 1 and pointer-event of all.

![modal with class open has opacity 1 and pointer-event of all](./874.png)
...
![translate the modal using transform and translateY in css](./875.png)
...
![when there is open property on parent .modalInner gets translated on y axios to 0](./876.png)
...
![clicking outside the modal and run closeModal function](./877.png)
...
![controlling the modal visibility via open class](./878.png)
...
![error - cannot read property nextElementSibling of undefined](./879.png)
...
![tab-index 0 attribute on img tag](./880.png)
