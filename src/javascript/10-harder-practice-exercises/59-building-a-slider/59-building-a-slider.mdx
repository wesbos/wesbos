...
![changing slides on the click on previous or next button](./882.png)
...
![translating a slide on X-axis](./883.png)
...
![parcel bundler recognize sass files](./884.png)
...
![adding start script in package.json](./886.png)
...
![typing element in console](./887.png)
...
![creation of startSlider function](./890.png)
...
![setting the class current](./891.png)
...
![current slide in console](./893.png)
...
![adding a paragraph on the top of html page](./897.png)
...
![executing $0, $0.nextSibling, $0.nextElementSibling after clicking on element](./898.png)
...
![startSlider function definition](./899.png)
...
![appropriate slides have class current](./900.png)
...
![prev and current class](./901.png)
...
![slides running on their own](./902.png)
