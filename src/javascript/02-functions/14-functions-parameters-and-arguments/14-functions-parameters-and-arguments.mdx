...
![calculateBill function computes the bill using scoped arguments as 100 for billAmount and 0.15 for taxRate](/calling-function-with-arguments-in-console.png)
...
![without passing an argument to sayHiTo function which accept a parameter prints undefined](/calling-function-without-any-argument.png)
...
![reusing same name as paraeters across different functions never collide with each other](/reusing-same-named-paraeters-in-different-functions.png)
