...
![screenshot of html output showing image with no class name 'cool'](./242.png)
...
![screenshot of rendered webpage showing image in a circle format](./1444.png)
...
![animated git showing an image being formatted as a circle then removed back to square](./round.gif)
...
![animated git showing an image being formatted as a circle then removed back to square with an animated transition](./round-transition.gif)
...
![animated git showing an image being formatted as a circle then removed back to square with an animated rotating 20 degrees transition](./transition1.gif)
...
![animated git showing an image being formatted as a circle then removed back to square with an animated rotating 2000 degrees transition](./transition2.gif)
...
![animated git showing an image being formatted as a circle then removed back to square with an animated rotating and scale transition](./transition3.gif)
