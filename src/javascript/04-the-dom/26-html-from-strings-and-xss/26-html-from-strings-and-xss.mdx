...
![Screenshot showing the rendered html output matches that which was defined in javascript](./266.png)
...
![Screenshot showing rendered html output of img with attached class that was defined in javascript](./268.png)
...
![Screenshot of rendered html showing multiple header tags](./274.png)
...
![Screenshot of webpage with active alert saying HACKED](./275.png)
