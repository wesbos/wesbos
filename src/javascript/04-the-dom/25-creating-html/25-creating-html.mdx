...
![Screenshot of the document.createElement MDN web docs page](./251.png)
...
![browser console showing output of myParagrah as empty tag](./252.png)
...
![browser console showing output of myParagrah with added class 'special'](./253.png)
...
![Screenshot of the node.appendChild MDN web docs page](./254.png)

```js
document.body.appendChild(myParagraph);
```

![Screenshot of rendered html showing p tag before the closing body tag](./255.png)
...
![Screenshot of rendered webpage showing a paragrah above an image](./257.png)
...
![Screenshot of the .append method MDN web docs page](./258.png)
...
![Screenshot of the .insertAdjacentElement method MDN web docs page](./259.png)
...
![Screenshot of rendered page showing a large heading below an image](./260.png)
...
![Screenshot of rendered page showing a paragraph before an image](./261.png)
...
![Screenshot of rendered html showing a list with multiple nodes](./1447.png)
