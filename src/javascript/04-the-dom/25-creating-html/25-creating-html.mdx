...
![the node.appendChild MDN web docs page](./254.png)

```js
document.body.appendChild(myParagraph);
```

![rendered html showing p tag before the closing body tag](./255.png)
...
![rendered webpage showing a paragrah above an image](./257.png)
...
![The .append method MDN web docs page](./258.png)
...
![The .insertAdjacentElement method MDN web docs page](./259.png)
...
![rendered page showing a large heading below an image](./260.png)
...
![rendered page showing a paragraph before an image](./261.png)
...
![rendered html showing a list with multiple nodes](./1447.png)
