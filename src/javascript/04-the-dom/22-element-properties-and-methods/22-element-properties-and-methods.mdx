...
![how to select and log to the browser console a h2 element](./229.png)
...
![outputs in the browser console when using textContent and innerText on elements](./230.png)
...
![html output of the pizza emoji being added into the p element before the p element itself](./233.png)
...
![html output of the pizza emoji being added into the p element just before its first child ](./234.png)
...
![html output clearly indicating that the html element has two strings inside of it](./235.png)
