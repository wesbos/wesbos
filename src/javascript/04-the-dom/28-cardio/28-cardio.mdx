...
![Screenshot of rendered page showing empty div](./297.png)
...
![Screenshot showing rendered page list with an image appended at the end](./299.png)
...
![Screenshot of rendered page with multiple paragaphs above list](./303.png)
...
![Screenshot of rendered html](./304.png)
...
![Screenshot of rendered page with dom elements being highlighted because they are selected in the browser console](./305.png)
...
![Screenshot of rendered page no longer showing paragraph one](./1449.png)
...
![Screenshot of rendered page showing a list of cards as text](./311.png)
...
![Screenshot of rendered page showing a list of cards wrapped in white boxes](./312.png)
...
![Screenshot of rendered page showing a list of cards wrapped in white boxes with delete buttons](./313.png)
