...
![Screenshot showing that when you hover on an text node in the browser console output it will highlight on the html page](./279.png)

Then the `emphasis` node.

![Screenshot showing that when you hover on an emphasis node in the browser console output it will highlight on the html page](./280.png)

Then the rest of the text.

![Screenshot showing that when you hover on the rest of the text node in the browser console output it will highlight on the html page](./281.png)
...
![Screenshot showing the output of various console logs on a querySelector of .wes](./283.png) 3:59
...
![Screenshot showing rendered html highlighting multiple divs with the class item](./287.png)
...
![Screenshot of brower console showing output from using $0.previousElementSibling](./288.png)
...
![Screenshot of browser console as user is typing a chained call .parentElement](./289.png)
...
![Screenshot of browser console as user is selection children by square bracket notation](./294.png)
...
![Screenshot of broswer console as user uses .remove](./295.png)
...
![Screenshot of browser console showing a logged out p tag](./296.png)
