...
![screenshot of rendered html showing image with an alt tag of cute pup](./243.png)
...
![browser console output showing 0](./244.png)

However, if you copy and paste that in the console and run it, you get a value of 600 back.

![browser console showing output of pic.naturalWidth as 600](./245.png)
...
![browser console showing the output of .getAttribute](./1445.png)
...
![browser console showing the output of .getAttrvute after setting via .setAttribute](./1446.png)
...
![screenshot of rendered html showing custom attirbute on the img element](./246.png)
...
![screenshot of rendered html showing data-name attributes on img elements](./247.png)
...
![browser console showing output of .dataset](./248.png)
...
![browser console showing a img element's custom datasets object](./249.png)
...
![screenshot showing an active alert on the webpage showing welcome wes bos](./250.png)
