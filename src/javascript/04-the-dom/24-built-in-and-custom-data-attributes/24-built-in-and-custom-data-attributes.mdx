...
![rendered html showing image with an alt tag of cute pup](./243.png)
...
![rendered html showing custom attirbute on the img element](./246.png)
...
![rendered html showing data-name attributes on img elements](./247.png)
