...
![cleanPeople array having random persons with their name and age](./657.png)
...
![creating subset of cleanPeople array by filtering out persons whose age is greater than 40](./659.png)
...
![filtering out persons whose age is greater than 40](./660.png)
...
![finding a student from array of students having id 565a](./661.png)
...
![undefined gets returned when there is no match for student with id 565a in students array](./662.png)
...
![using filter instead of find method to get a student with id 565a](./663.png)
...
![using higher order function named findById to find a student with id 56a from the list of array](./664.png)
...
![findByProp method to find the student from students array using one of their properties like id and first_name](./666.png)
...
![findByProp method takes property as first parameter](./667.png)

In the image above, the text that is selected is the property `last_name`. It is the property key.

![findByProp method takes the value we are looking for as second parameter](./668.png)
...
![comparing the property value with the value specified for the item of array](./669.png)
