...
![browser console output of bang checks](./389.png)
...
![browser console output showing you have 2 items in your cart](./390.png)

If you changes `count` to be 1, it would return the following sentence 👇

![browser console output showing you have 1 item in your cart](./391.png)
...
![browser console output showing you have 0 items in your cart](./392.png)
...
![browser console showing output from various check functions](./393.png)
...
![browser console showing output from various check functions](./394.png)
