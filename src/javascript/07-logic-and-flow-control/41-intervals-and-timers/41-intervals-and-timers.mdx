...
![browser console output showing timeout logs](./429.png)
...
![browser console output showing ENNGGGGGGG with a 51 count](./430.png)
...
![code snippet showing setImmediateInterval code](./433.png)
...
![code snippet showing setImmediateIntervale being called with buzzer passed in](./434.png)
...
![browser console output showing various outputs](./435.png)
...
![rendered page text saying DESTORYED](./436.png)
...
![browser console showing the ouput from bombTimer](./437.png)
...
![browser console showing output from typeof bopmbTimer](./438.png)
...
![browser console showing various outputs of Hehehe and poo emojis](./439.png)
