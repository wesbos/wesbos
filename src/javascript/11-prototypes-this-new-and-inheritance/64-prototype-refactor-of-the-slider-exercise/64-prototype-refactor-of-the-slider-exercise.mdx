...
![selecting the elements using querySelector](./961.png)

You should see the following in the console

![log of mySlider and dogSlider](./962.png)
...
![log of instance of the slider for each instance](./963.png)
...
![uncaught type error: cannot read property 'querySelector' of undefined](./964.png)
...
![console log in the sources tab of browser](./965.png)
...
![using querySelector everywhere in the slider function](./966.png)
...
![initializing the slider instances](./967.png)
...
![issue with startSlider function where we are using this.slider function](./969.png)
...
![calling move funtion and passing reference of move function in first and second event listener](./970.png)
...
![selecting the prev and next buttons using querySelector](./971.png)
...
![calling the move function on dogSlider object in console](./972.png)

What you could do is at the bottom of the page add an event listener on the window's keyup event like below.

![event listener keyup to window object](./973.png)
