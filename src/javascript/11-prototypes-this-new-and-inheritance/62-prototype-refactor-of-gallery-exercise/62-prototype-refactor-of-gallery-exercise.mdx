...
![Gallery() function not returning anything](./928.png)
...
![null check of gallery argument](./930.png)
...
![both galleries logged in console](./931.png)
...
![right clicking the variable and selecting go to definition](./932.png)

![selecting all the images using querySelectorAll](./933.png)
...
![console log of gallery with having properties in it](./934.png)
...
![access of openModal function in console ](./935.png)
...
![selecting and putting cursor in front of multiple functions using shortcuts ](./936.png)
...
![uncaught error - handleClickOutside is not defined](./937.png)
...
![problems in code highlighted by ESLint](./938.png)
...
![uncaught type error: cannot read property 'nextElementSibling' of undefined](./939.png)
...
![adding this keyword to access objects own property](./940.png)

Let's add a log and take a look. As far as we know, `this` should always equal the instance of the gallery.

![uncaught type error: cannot read properties 'nextElementSibling' of undefined](./941.png)
...
![showNextImage function is called within closeModal function](./943.png)
...
![creating an anonymous function inside event listener and calling this.showNextImage()](./944.png)
