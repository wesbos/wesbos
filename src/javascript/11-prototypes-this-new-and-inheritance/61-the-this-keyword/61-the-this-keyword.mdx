...
![this keyword equals to each button that was clicked](./918.png)
...
![window object log in console](./919.png)
...
![log of this keyword directly inside arrow function and the setTimeout function](./920.png)
...
![log describing outside and inside function in console](./921.png)
...
![accessing this keyword within tellMeABoutTheButton with arrow function](./922.png)
...
![logs of this keyword inside setTimeout function](./923.png)
...
![log of this keyword returning inside a function](./924.png)
...
![documentation describing generating random hex color code in javascript](./925.png)
...
![console log the contents of pizza function](./926.png)
...
![pizza object with toppings, customer and id proerties](./927.png)
