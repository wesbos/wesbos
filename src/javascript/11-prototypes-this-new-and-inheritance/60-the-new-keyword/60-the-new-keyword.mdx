...
![prototype of tons of method for date in console](./904.png)

Let's say you were to log `myDate.getFullYear()`, you will see we get 2025 in the console.

![log of myDate.getFullYear() in console](./905.png)
...
![log of functions run with the new keyword](./906.png)
...
![executing toLocaleString() function on the number object](./907.png)
...
![typeof and instanceof operator with date](./908.png)
...
![typeof and instanceof operator with arrays](./909.png)
...
![log of names holding array and wes holding object, created using new keyword](./910.png)
...
![log of span instanceof Element, returning true](./911.png)
...
![log of span as instanceof HTMLSpanElement and Node](./912.png)
...
![undefined log in console](./914.png)
...
![console of pizza object with its constructor](./915.png)
...
![log of the object constructor](./916.png)
...
![logging the constructor of span element](./917.png)
