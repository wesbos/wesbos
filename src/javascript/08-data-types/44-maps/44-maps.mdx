...
![browser console output showing myMap Map instance](./489.png)
...
![browser console output showing myMap Map instance with manually added attribute age](./491.png)
...
![browser console output showing new map entry using .set() method](./492.png)
...
![browser console output showing person1 object added as new myMap entry](./494.png)
...
![browser console output showing myMap entry person1 using .get() method](./495.png)
...
![browser console output showing console.log() of winning prize](./496.png)
...
![browser console output showing prizes Map instance iterited through using forEach method](./497.png)
...
![browser console output showing prizes Map instace iterated through using for of method](./498.png)
...
![browser console output showing prizes index 0 and 1 using console.log()](./499.png)
...
![browser output showing prizes entries](./500.png)
...
![browser console output showing creation of new map with an array of arrays](./501.png)
...
![browser console output showing map entry deletion using .delete method](./502.png)
...
![browser console output showing json object turned to string using JSON.stringify() method](./503.png)
...
![browser console output showing stringified map instance causing error. Awaiting on JSON 5 :)](./504.png)
...
![browser console output of myMap using .fromEntries() method](./505.png)
