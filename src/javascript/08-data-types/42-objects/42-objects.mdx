...
![Browser console showing output of javascript object person](./440.png)
...
![code snippet of object person with name of 'wes' and age of 100](./441.png)
...
![code snippet of object person with age attribute highlighted](./442.png)
...
![browser console output with person object new attribute cool-dude highlighted](./443.png)
...
![code snippet of person object showing attributes containing dashes & space](./445.png)
...
![browser console output showing syntax error when you forget trailing comma](./446.png)
...
![browser console output person object showing nested attributes](./448.png)
...
![browser console output showing new person object attribute job added via dot notation](./449.png)
...
![browser console output showing person object attribute age overwritten via dot notation](./450.png)
...
![browser console output showing error when re-assigning new value to const variable](./451.png)
...
![browser console output showing unmutated age attribute when invoking Object.freeze()](./452.png)
...
![browser console output showing wes object](./453.png)
...
![windows.prompt pop up to check if assigned attribute is used via brackets notation](./455.png)
...
![browser console output error on object attribute check containing dash/space via dot notation](./457.png)
...
![browser console output showing multi-nested attribute lookup for wes.clothing](./458.png)
...
![browser console output error on undefined object attribute](./459.png)

However, if you try to access a nested property on a property that does not exist, it will throw an error 👇

![browser console output error when accessing child-level attribute of an undefined parent-level attribute](./460.png)
...
![browser console output showing a check if attribute is assigned or not](./461.png)
...
![browser showing text type input](./462.png)
...
![browser console output showing deleted object property on lookup as undefined](./463.png)
...
![browser console output showing sayHello() method with passed parameter](./464.png)
...
![browser console output of a arrow function method evaluation to windows object](./465.png)

If you were to change that, to a regular function, `this` would be equal to wes.

![browser console output of a regular function method evaluation to javascript object](./466.png)
