...
![browser console output showing name1 and name 2 value as wes](./467.png)
...
![browser console output showing name2 and name1 values as westopher and wes respectively](./468.png)
...
![browser console output showing person1 is not equal to person2](./469.png)
...
![browser console output showing person3 object](./470.png)
...
![browser console output with person3.first updated attribute as Larry](./471.png)
...
![browser console output both person3 and person1 first as Larry](./472.png)

If you try typing `person1`, `person2`, and `person3` in the console, you should see the following returned 👇

![browser console output showing person1, person2, and person3 objects](./473.png)
...
![browser console output showing updated person3.last object to Cool is reflective on  person1.object](./474.png)
...
![browser console output showing person3 object](./475.png)
...
![browser console output showing person3.first and person1.first attributes](./476.png)
...
![browser console output showing person3 as copy of person1 using spread operator](./477.png)
...
![browser console output showing objects person3 and person1  clothing.shirts attribute both updated to 100](./478.png)
...
![lodash documentation page showing .clone method](./479.png)
...
![lodash documentation page showing .cloneDeep method](./480.png)
...
![browser console output showing objects person3 as a copy of person1 using lodash' .cloneDeep method](./482.png)
...
![browser console output showing object inventory attribute defined with spread operatory](./484.png)
...
![browser console output showing object attribute inventory with sub-attribute oyster added manually](./485.png)
...
![browser console output shows similarly defined attributes is dependent on spread order](./486.png)
...
![browser console output shows object added attribute tomotoes as passed through doStuff2 function](./487.png)
...
![browser console output shows mutated objects passed through a function reflects external objects](./488.png)
