...
![typeof values shown in the console](/1438.png)
...
![simple math in the console](/55.png)
...
![strings of 10 and 10 can be multiplied](/57.png)
...
![autocompletion of the Math static methods](/58.png)
...
![Console rouning 20.5 up to 21 and 20.2 down to 20](/59.png)

There is also `Math.floor()` which will give you the lower end of that number.

![console showing 20.2 and 20.999999 rounded down to 20](/60.png)

We have `Math.ceil()` and that will give you the upper number.

![console showing 20.2 and 20.999999 rounded up to 21](/61.png)
...
![Console showing Math.random() returning a random number each time](/62.png)
...
![Each kid gets 6.66666666667 in the console](/63.png)
...
![Each kid gets 6 smarties int he console](/64.png)
...
![Modulo Operator returning 2](/65.png)
