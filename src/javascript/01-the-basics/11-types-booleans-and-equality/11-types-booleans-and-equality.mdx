...
![comparing age as 18 greater than ofAge as 19 results in false](/boolean-false-in-console.png)
...
![use of triple equal operator to compare age with 100](/triple-equals-comparison-in-console.png)
...
![comparing two variables age with age2 using triple equal operator](/triple-equal-operator-comparison-between-variables-in-console.png)
...
![comparing double equals with triple equals in console for numbers](/comparing-double-equals-with-tripple-in-console.png)
...
![comparing string as 10 and number as 10 using double equalto with returns true while triple equals to does not](/string-and-number-comparison-using-two-ways.png)
