...
![Console showing unexpected apostrophe](/unexpected-identified-apostrophe.png)
...
If you want to, you have to put a backward slash at the end of every single line, and that will allow you to put a string on multiple lines.
...
![Variable being logged to the console](/i-like-pizza-console.png)
...
![Multi line console log](/i-like-pizza-backticks-console.png)
...
![Console showing string concatenation](/addition-with-strings-and-numbers.png)
...
![Generated HTML in the console](/interpolated-html-string.png)
...
![Interpolated values being shown in HTML](/interpolated-html-string-browser.png)
