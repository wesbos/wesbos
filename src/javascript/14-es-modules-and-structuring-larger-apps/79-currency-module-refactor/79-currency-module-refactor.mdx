...
![uncaught reference error - generateOptions is not defined](./1238.png)
...
![uncaught reference error - currencies is not defined](./1239.png)
...
![uncaught syntax error - requested module does not provide an export named currencies](./1240.png)
...
![uncaught reference error - handleInput is not defined](./1241.png)
...
![uncaught reference error - convert is not defined](./1242.png)
...
![uncaught reference error - fromInput is not defined](./1244.png)
...
![div with class app in elements tab](./1245.png)
...
![uncaught reference error - fromSelect is not defined](./1246.png)
...
![setting the innerHTML using html](./1247.png)
...
![uncaught reference error - ratesByBase is not defined](./1248.png)
...
![uncaught reference error - generateOptions is not defined](./1249.png)
...
![uncaught reference error - currencies is not defined](./1250.png)
...
![dependency cycle detected eslint warning in code](./1251.png)
...
![select a currency and on hovering over the form, currency is switched out to usd](./1252.png)
