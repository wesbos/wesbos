...
id: 1447
---
At my [jQueryTO talk](https://wesbos.github.io/Sublime-Text-Power-User-Talk) I showed a new Sublime Text Package called GutterColor that allows you to view your CSS colours in your gutter.
...
No idea what brew or macports is? You'll need to install that first before you can install ImageMagick. I recommend using [HomeBrew](http://brew.sh/). Simply open your terminal window (found in applications → Utilities → Terminal) and paste the following code in and hit enter:
...
Head on over to the [ImageMagick website](http://www.imagemagick.org/script/binary-releases.php#windows) and download/install the option that works with your computer. If you download the wrong version, no worries, just try another version.
...
{ "convert\_path" : "/usr/local/bin/convert" }
...
[![](facebook-share2.png)](https://sublimetextbook.com/?utm_source=guttercolor&utm_medium=banner&utm_campaign=product)