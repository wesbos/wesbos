...
Web tooling is changing at an extremely rapid pace right now and there is a sense of exhaustion, being overwhelmed and anxiety of becoming out of date. "Why is this stuff moving so fast?" cry the developers. ![Artboard 1](Artboard-1-650x356.png)

JavaScript `var is [dead](https://twitter.com/wesbos/status/599310841331077120)? We should use ES2015 let and const` now?
...
Just built a project using protocol relative `// - that's [an anti-pattern](http://www.paulirish.com/2010/the-protocol-relative-url/) now. Oh and jQuery .hide()` is [bad for performance](https://github.com/jquery/jquery.com/issues/88), so cut that out.
...
[https://twitter.com/micahgodbolt/status/603190108766937088](https://twitter.com/micahgodbolt/status/603190108766937088)
...
[![](facebook-share2.png)](https://sublimetextbook.com/?utm_source=overwhelmed&utm_medium=banner&utm_campaign=product)
