...
Hit`Command + Shift + P` to bring up the sublime launcher type **"user global settings** and hit enter. This file is similar to a .vimrc file and holds all of your custom settings. This file wont be written over when you upgrade like **default global settings**. Once you have this file open, add the following line:
