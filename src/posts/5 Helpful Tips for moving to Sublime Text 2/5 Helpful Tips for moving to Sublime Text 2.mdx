...
## 2. Open files in current sublime text window
...
## 3. Get Code Hinting in Sublime Text 2

![Sublime Text 2 Code Hinting](Screen-Shot-2011-09-22-at-4.21.45-PM.png "Sublime Text 2 Code Hinting")One feature that Coda has just slam dunked is their code hinting. I rarely ever have to type entire key words. A solution for getting code completion working in Sublime Text is to install SublimeCodeIntel, a port of the Komodo editor code  completion engine. It isn't perfect, particularly in CSS file, but its pretty good and gets the job done.  [Download the repo here ](https://github.com/Kronuz/SublimeCodeIntel "Sublime Code Completion") and drop it into your packages folder at` ~/Library/Applications/Sublime Text 2/Packages`

 

 

## 4. Upload with Transmit shortcut
...
Next, install [Sublime Transmit Docksend](https://github.com/jeffturcotte/sublime_transmit_docksend), The way this package works is by simulating a docksend (drag and drop a linked local file) to transmit when a key combination is pressed.
...
## 5. Create your own snippets!

It's a given that you should have already installed [Zen Coding](http://code.google.com/p/zen-coding/ "Zen Coding for Sublime Text"), but there are always snippets that are developer specific that you use on a daily basis. For me, I use `j + tab  to expand into a jQuery selector $(' '); To setup your own snippets, go to tools->New Snippet. The XML markup is fairly straightforward so I wont go into it. Just plop your code inbetween and ]]>`. You can even set areas to tab through the snippet as well as defaults.
...
There is a lot more to Sublime Text 2, and many cool new features such as code folding and Vim support are currently in development. I will go into many more features in coming blog posts. Want to know how to do something? Just ask in the comments below! Be sure to also [Follow me on Twitter](http://twitter.com/wesbos).
