...
![people-js-shirts](people-js-shirts.jpg)
...
<h4>Can I get one in `$color` || `$garmentType` || `$design` I've made a handful of different options available that should suit most tastes - if you aren't fond of the design or shirt types, I'd love to hear what you would like best, but this time around it's all I'm offering
