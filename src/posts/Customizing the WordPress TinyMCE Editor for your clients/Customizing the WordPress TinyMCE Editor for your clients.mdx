...
```php
function make_mce_awesome( $init ) { // our Options will go here.. return $init; } add_filter('tiny_mce_before_init', 'make_mce_awesome');
```
