...
I'm still on a hunt for a for a fix to get the comment shortcut working - or even a small package that would toggle them on and off. If anyone is interested in working on this (and knows Python) - let me know!
