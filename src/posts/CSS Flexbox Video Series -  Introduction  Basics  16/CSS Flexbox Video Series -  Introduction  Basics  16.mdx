...
![](ss-2015-06-24-at-2.03.04-PM-300x201.png)**Update:** While these videos are still a fantastic intro to flexbox, I'm working on a much more in depth, **free** video series called What The Flexbox - will be out in a few weeks! In the mean time check out my free [Command Line Power User](http://CommandLinePowerUser.com) video series as well!

<form class="sendy" action="http://bostype.com/sendy/subscribe" method="POST">

### Tell me when it launches!

<input name="email" required="" type="email" placeholder="Enter Your Email"><input name="list" type="hidden" value="Ct7zsQu3UIBOKuXcvE583Q"><input name="boolean" type="hidden" value="true"> <input type="submit" value="Let me know, Wes!"></form>
