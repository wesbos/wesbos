...
<blockquote>In addition, experienced users often like to speed up the reading rate to 300 words per minute or more, which is more than the inexperienced listener can easily understand.</blockquote>
...
<blockquote>Consume 2x the amount of content, learn twice as much in the same amount of time!</blockquote>
