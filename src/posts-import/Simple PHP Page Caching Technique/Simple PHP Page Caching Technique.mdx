...
image: pagecache.png
tags: example,page-cache,php,snippet
date: 2011-03-15T10:17:20
---

This is a little code snippet that I use in almost every project that isn't based on a popular CMS. Since its fairly expensive to hit the database on every page load, its a smart idea to cache the plain HTML markup of your page and serve that up. You can set how often the page cache is flushed out depending on how often you update your site's content.<!--more-->
