...
I'll go into the technical details further on in the post, but here is a demo as well as a youtube video showing the effect as it can be a little sluggish on older machines. Currently tested and working in Google Chrome 14 and Firefox 6.0. <!--more-->
...
This is where all the magic happens. Read through each line and realize what is happening. Pay specific attenton to the <code>ccv.detect_objects()</code> function.
