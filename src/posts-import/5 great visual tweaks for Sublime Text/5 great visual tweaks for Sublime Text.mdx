...
Here are five visual changes you can use to make your text editor <em>just right</em>. You should place these items inside your User settings file which can be located at <code>preferences</code> → <code>Settings - User</code>
