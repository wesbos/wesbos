...
**** <em><strong>UPDATE: </strong></em><strong>In Sendy 3 they have added list segmentation! ****</strong>

<img class="aligncenter size-full wp-image-3550" src="mailchimp-to-sendy1.png" alt="mailchimp-to-sendy" width="500" height="300" />
...
After a listen to <a href="https://blog.codepen.io/2015/05/06/40-newsletters/">this codepen radio podcast</a> on how they use a transactional email provider to send their emails, I went looking for other solutions.

This is when I stumbled upon <a href="http://wes.io/bvN7">Sendy</a> - a self-hosted PHP-based solution that is just the right amount of work to replace my MailChimp needs all together. It works by hooking into Amazon's SES (or another transactional email provider like SendGrid or Madrill via SMTP) to send your emails out. You pay $65 once for Sendy and then $1 per 10,000 emails sent via SES.
...
Sendy isn't a service - it's just a codebase that you run yourself on your own server - kind of like running your own WordPress. You'll need your own PHP server for this - I run mine on a <a href="http://wes.io/bvcH">cheap Bluehost</a> account.
