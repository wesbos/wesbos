...
Now the example given is great, however it doesn't jive well when you want to add in a friendly library like jQuery. So here is how we fixed it:<!--more-->
...
```
And that is it! <a href="http://wesbos.com/demos/google-geo-map-visualization/">Take a look at the demo</a> and view source for the rest of the HTML markup.