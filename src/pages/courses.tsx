...
export default function CoursesPage(props: PageProps<'/courses'>) {
  return (
    <>
      ...
      <p>
        Ready to learn and up your game as a web developer? Here is a listing of all the courses I've put out. Some of
        them are paid and some of them are free.
      </p>
      <p>
        I'm delivering a few new courses every year, so sign up for any of these courses and you'll hear when I announce
        new ones!
      </p>
      <div className={styles.CourseListStyles}>
        <div className="course">
          ...
          <p>
            Building modern websites is tough. Preloading, routing, compression, critical CSS, caching, scaling and
            bundlers all make for blazing fast websites, but extra development and tooling get in the way.
          </p>
          <p>
            Gatsby is a React.js framework that does it all for you. This course will teach you how to build your
        ...
        <div className="course">
          ...
          <p>
            This is a course that will teach you everything you need to build a full stack application with React.js and
            GraphQL.
          </p>
          ...
          <p>
            We cover everything from authentication and sending email to uploading photos and caching data. The entire
            front-end is built in modern React.js and GraphQL.
          </p>
          <p>
            I'm also happy to announce that the course has almost six hours of testing videos included in the master
            package. Testing is something I've had requests for a long time and I'm really excited to deliver on some
            good quality testing material.{' '}
          </p>
        </div>
        <div className="course">
          <img
          ...
          <p>
            ES6 is a major update to JavaScript that includes dozens of new features. With a focus on simplicity and
            readability, this premium video course is the best way to learn about all that ES6 has to offer while
            sharpening your core JavaScript skills.{' '}
          </p>
        </div>
        <div className="course">
          <img
          ...
          <p>
            A free 30 day vanilla js coding challenge. Learn to build 30 things in 30 days with 30 tutorials. No
            Frameworks, No Compilers, No Libraries, No Boilerplate. Good luck!{' '}
          </p>
        </div>
        <div className="course">
          <img
          ...
          <p>
            Upgrade your JavaScript skills to learn React.js in just a couple of afternoons. A premium step-by-step
        ...
        <div className="course">
          ...
          <p>
            Flexbox sure is tricky to learn. Get a grasp on flexbox while learning both the fundamentals and real world
            applications.{' '}
          </p>
        </div>
        <div className="course">
          ...
          <p>
            As web developers, we use the command line a lot. A video series for web developers on learning a modern
            command line workflow with ZSH, Z and related tools.
          </p>
        </div>
        <div className="course">
          <img
          ...
          <p>
            A 20 video / 2.5 hour course to learn how to use Redux, React Router and React together. This course is
            intended as a next step to my <a href="https://ReactForBeginners.com">React for Beginners</a> course.
          </p>
        </div>
        <div className="course">
          <img
