...
![typeof person is object](./typeof-person-in-console.png)

You can expand the object in the console to see it like so 👇

![expanding object in console](./expand-object-in-console.png)
...
![different ways to access object properties](./different-ways-to-access-object-properties-in-console.png)
