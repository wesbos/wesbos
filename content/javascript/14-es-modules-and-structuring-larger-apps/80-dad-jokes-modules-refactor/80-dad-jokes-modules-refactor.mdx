...
![copy and cut fetchJooke function into the index.js](./1253.png)
...
![reference error - handleClick is not defined](./1254.png)
...
![uncaught reference error - fetchJoke is not defined](./1255.png)

![exporting handleClick function as named export](./1256.png)
...
![uncaught reference error - loader is not defined](./1257.png)
...
![uncaught reference error - loader is not defined](./1258.png)
...
![uncaught reference error - jokeHolder is not defined](./1259.png)
...
![uncaught reference error - jokeHolder is not defined](./1260.png)
...
![uncaught reference error - randomItemFromArray is not defined](./1261.png)
...
![uncaught reference error - buttonText is not defined](./1262.png)
