...
![browser console showing buns.join() invoked](./552.png)
...
![browser console showing buns.join() invoked with pass parameter](./553.png)
...
![browser console showing foodString with .split() method with comma delimeter passed as parameter](./554.png)
...
![browser console showing string ran with .split() method](./555.png)
...
![browser console showing string with emoji ran with .split() method](./557.png)
...
![browser console showing toppings array](./558.png)

If you call `toppings.pop()`, it will return to us the last item in the array, which is "Cheese".

![browser console showing toppings.pop(), returning last element from the array](./559.png)

If you take a look at `toppings` again, you will see that "Cheese" is no longer part of the array.

![browser console showing mutated toppings array without last element](./560.png)
...
![browser console showing new array length after calling .pop() method](./561.png)
...
![browser console showing toppings array with last removed element added back](./562.png)
...
![browser console showing fist element of toppings array removed via .shift() method](./563.png)
...
![browser console showing newToppings array made using spread operator and slice method](./565.png)
...
![MDN Documentation on Array slice method page](./567.png)
...
![browser console showing toppingsCopy array](./568.png)
...
![browser console showing toppingsCopy is a true copy with unmutated first element](./569.png)
...
{/* TODO: where did this image go? ![](./571.png) */}
...
![browser console showing wes object at index 1](./572.png)
...
![browser console showing -1 as indexOf parameter was not found](./573.png)
...
![browser console showing false boolean result of two objects comparison](./574.png)
...
![browser console showing Array.includes() method example](./575.png) 1
...
![browser console showing false boolean result](./576.png)
...
![browser console showing toppings added if not already included](./577.png)
...
![browser console showing toppings array in reverse via reverse() method](./578.png)
