...
Compile your coffeescript and hop back into your terminal and type `node server.js`. You now have a web socket server running on port 4000. ![](Screen_Shot_2011-08-12_at_7.35.45_PM.png)

If you go to localhost:4000 you'll see the following:

![](Screen_Shot_2011-08-12_at_7.36.08_PM.png)
