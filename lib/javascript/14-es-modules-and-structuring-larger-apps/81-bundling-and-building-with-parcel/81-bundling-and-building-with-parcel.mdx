...
![type npm init command to initialize a package.json](./1266.png)
...
![package.json after answering a bunch of questions](./1267.png)
...
![add parcel-bundler in devDependencies](./1268.png)
...
![type npm start command that will run parcel index.html](./1269.png)

Open up the server, and take a look at the error in the console. We have run into this issue before.

![uncaught reference error - regeneratorRuntime is not defined](./1270.png)
...
![parcel also compile all the css for us](./1275.png)
...
![if we re run the npm run build command, you will notice number of files are the same](./1276.png)
...
![if we add a log statement at the bottom of jokes.js and re run the build we see number in the jokes javascript file have changed](./1277.png)
