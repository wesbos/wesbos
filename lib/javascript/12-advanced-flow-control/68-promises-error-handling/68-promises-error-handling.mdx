...
![promise rejection error - uncaught in promise](./1037.png)
...
![catching the uncaught promise error and logged in console](./1038.png)
...
![not every promise needs a catch statement at the end](./1040.png)
...
![in chain of promises - error uncaught promise](./1041.png)
...
![handling the error in chanin of promises in code](./1042.png)
...
![output of promise as first one fulfilled, second one rejected using Promise.allSettled()](./1043.png)
...
![Promise.all() produces error in console if one of the promise is rejected](./1044.png)
...
![using catch handler with Promise.all()](./1045.png)
