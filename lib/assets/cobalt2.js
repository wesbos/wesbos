// Have to store this theme locally, becauise its' JSON5 and I'm not going to use FS apis to read it so I can host anywhere.
export const cobalt2 = {
  ...
  colors: {
    ...
    // Editor Bracket Highlight colours
